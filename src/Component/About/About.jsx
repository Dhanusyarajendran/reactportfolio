    ...
    return (
        <div className='container-fluid' id='About'>
            <div className='row about-section'>
                ...
                <div className='col-lg-6 col-md-6 col-12 about-image' data-aos="fade-right">
                    <img
                        src={aboutimage}
                ...
                <div className='col-lg-6 col-md-6 col-12 about-content' data-aos="fade-left" data-aos-delay="150">
